...
class Transaction:
    ...
    def __init__(self, sender_public_key, sender_private_key, recipient_public_key, amount, messageheader, messagecontent):
...
def generate_transaction():
    ...
    messageheader = request.json['messageheader']
    messagecontent = request.json['messagecontent']

    transaction = Transaction(sender_public_key, sender_private_key, recipient_public_key, amount, messageheader, messagecontent)
